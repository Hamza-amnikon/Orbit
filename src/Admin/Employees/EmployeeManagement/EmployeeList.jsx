...
function EmployeeList() {
  ...
  async function fetchEmployees() {
    try {
      ...
      const response = await axios.get("http://localhost:5151/api/employee");
  ...
  const filteredEmployees = useMemo(() => {
    return employees.filter((employee) => {
      ...
      const searchMatch =
        ...
        employee.azureEmployeeId?.toLowerCase().includes(keyword) ||
  ...
  const syncEmployees = async () => {
    try {
      ...
      const response = await axios.post("http://localhost:5200/api/sync");
      ...
      if (error.response) {
        ...
        alert("Unable to connect to the Sync Service.");
      }
    } finally {
      setLoading(false);
    }
    ...
    <div className="employee-list-page">
      ...
      <div className="employee-page-header">
        <div>
          ...
          <p>Manage, search and organize employees across your organization.</p>
        </div>
      ...
      {loading ? (
        <div className="loading-card">
          ...
          <p>Please wait while we fetch employee records.</p>
        </div>
